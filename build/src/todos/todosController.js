...
let UsersController = class UsersController extends tsoa_1.Controller {
    getTodo(todoId) {
        return __awaiter(this, void 0, void 0, function* () {
            return new todosService_1.TodosService().get(todoId);
        });
    }
    createTodo(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            this.setStatus(201); // set return status 201
            new todosService_1.TodosService().create(requestBody);
            return;
        });
    }
};
...
], UsersController.prototype, "getTodo", null);
__decorate([
    (0, tsoa_1.SuccessResponse)("201", "Created") // Custom success response
    ,
    (0, tsoa_1.Post)(),
    __param(0, (0, tsoa_1.Body)())
], UsersController.prototype, "createTodo", null);
