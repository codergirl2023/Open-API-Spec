...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { UsersController } from './../src/todos/todosController';
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/todos/:todoId',
            ...
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.getTodo)),

            function UsersController_getTodo(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/todos',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.createTodo)),

            function UsersController_createTodo(request: any, response: any, next: any) {
            const args = {
